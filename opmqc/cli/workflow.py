...
from opmqc.quality_reference import list_existing_quality_references
from opmqc.quality_reference import update_quality_reference_file, process_meg_quality
...
def update_quality_reference(device_name, quality_reference_file, overwrite):
    """
    Update the quality reference YAML file for a specific device in the opmqc library.
    """
    try:
        ...
        # Update the quality reference file in the opmqc library
...
def list_quality_references():
    """
    List all existing quality reference YAML files in the opmqc library.
    """
    try:
