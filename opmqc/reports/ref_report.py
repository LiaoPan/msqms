...
class Report(object):
    ...
    def gen_preliminary_conclusions_html(self):
        ...
        if PY_VERSION >= (3, 6):
            ...
            con_meg_info = "<b>%s</b>  minutes MEG recording suggests a generator at <b>%s</b> ." % (
            meg_duration_min, meg_position)
            con_ied_info = "<b>%s</b>  IED events and <b>%s</b> IED clusters have been found." % (
            ied_events_num, ied_clusters_num)
